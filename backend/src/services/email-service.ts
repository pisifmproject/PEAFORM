...
export const buildNewRegistrationEmailHtml = (opts: {
  ...
  const approveUrl = panelUrl;
  const rejectUrl  = panelUrl;
      ...
      <tr>
        <td class="content">
          ...
          <div class="action-container">
            <p style="margin-top: 0; margin-bottom: 15px; font-family: Arial, sans-serif; font-size: 14px; color: #475569;">Pilih tindakan untuk permintaan akun ini:</p>
            <table width="100%">
              <tr>
                <td align="center">
              ...
              <tr>
                <td align="center" style="padding-top: 15px;">
                  <a href="${panelUrl}" class="btn btn-panel">Buka Admin Panel</a>
                </td>
              </tr>
            </table>
          </div>
          ...
          <!-- Note -->
          <div class="note">
            <strong>Catatan:</strong> Tombol Approve / Reject di atas akan mengarahkan Anda ke halaman 
